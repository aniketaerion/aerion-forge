...
$MilestoneMap = @{
    ...
    "M3.7" = @{
        Name = "Build Verification and Release Gate"
        ProductionRegex = '^forge[\\/]build_verification[\\/]'
        TestRegex = '^tests[\\/]test_build_verification_.*\.py$'
        DocumentationRegex = '^docs[\\/]build_verification[\\/]'
    }
}
