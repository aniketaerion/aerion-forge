...
from forge.domain_intelligence.phase_validation.cli import phase_validation_app
...
from forge.mission_runtime.cli import app as mission_runtime_app
...
app.add_typer(phase_validation_app, name="phase-validation")
