...
def test_unknown_disabled_id_strict_and_non_strict() -> None:
    ...
    assert result.registry.statistics.available_capabilities == 15
...
def test_deterministic_build_and_query_api() -> None:
    ...
    assert len(query.list_available_capabilities()) == 15
    assert len(query.list_planned_capabilities()) == 16
